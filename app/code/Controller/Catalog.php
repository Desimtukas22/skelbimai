...
class Catalog extends AbstractController
{
    ...
    public function index()
    {
        ...
        $this->data['ads'] = Ad::getAllAds($page * 4, 4);
    ...
    public function add()
    {
        ...
        $form->textArea('description', 'Aprašymas');
